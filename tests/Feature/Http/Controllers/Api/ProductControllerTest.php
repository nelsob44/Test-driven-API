...
class ProductControllerTest extends TestCase
{
     ...
     * @test
     */
    public function non_authenticated_users_cannot_access_the_following_endpoints_for_product_api()
    {
     ...
     * @test
     */
    public function will_fail_with_validation_errors_when_creating_a_product_with_wrong_input()
    {
     ...
     * @test
     */
    public function will_fail_with_a_404()
    {
     ...
     * @test
     */
    public function will_fail_with_a_404_if_product_to_update_not_found()
    {
     ...
     * @test
     */
    public function will_fail_with_a_404_if_product_to_delete_not_found()
    {
